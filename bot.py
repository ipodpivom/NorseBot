...
# Flash модель отлично справляется с большими текстами
...
# 🔥 ВЕРНУЛ 8000+ ЗНАКОВ И ДОБАВИЛ ДЕТАЛИЗАЦИЮ
SYSTEM_PROMPT_TEXT = """
...
СТРУКТУРА:
1. ЭТИМОЛОГИЯ (Происхождение имен/названий).
2. МИФ/ИСТОРИЯ (Самая большая часть, детальный пересказ легенды).
3. СИМВОЛИЗМ (Глубокий разбор смыслов).
4. СВЯЗЬ С СОВРЕМЕННОСТЬЮ.
ПРАВИЛА:
- Не используй жирный шрифт.
- Используй обычный регистр (не капс).
Тема: 
"""
